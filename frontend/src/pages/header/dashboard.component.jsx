...
const Dashboard = () => {
   ...
   useEffect(() => {
      if (localUser.userObj.role === "Admin") {
         ...
         >
            ...
            <Nav className="flex-grow-1 d-flex align-items-center">
               ...
               <div className="admin-links-container">
                  {localUserObj.role === "Admin" && !questionType && (
                     <>
                  ...
                  {localUserObj.createQuestions && !questionType && (
                     <>
                  ...
                  {localUserObj.reviewQuestions && !questionType && (
                     <>
            ...
            <div className="user-name">
               ...
               {localUserObj.first_name + " " + localUserObj.last_name}
               <span
