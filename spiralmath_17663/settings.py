"""
Django settings for spiralmath_17663 project.
...
WSGI_APPLICATION = 'spiralmath_17663.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'spiralmath_17663.exception_handler.exception_handler',
    'PAGE_SIZE': 100,
}
...
if DEBUG:
    ...
    sentry_sdk.init(
        dsn="https://74812167d018485aba73299578204fb5@o500601.ingest.sentry.io/5614872",
